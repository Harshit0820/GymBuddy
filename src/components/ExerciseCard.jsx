...
function ExerciseCard(props) {
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      ...
      <div className="grid md:grid-cols-4 gap-2 text-center md:text-left">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid 
        border-blue-900 hover:border-blue-600 w-full items-center justify-center md:items-start md:justify-start"
        >
